...
const turnserver_ip = document.getElementById('turnserver_ip').innerHTML
const turnserver_port = document.getElementById('turnserver_port').innerHTML
//  stun/turn servers.
const iceservers = {
    iceServers: [
      ...
      ,
      {
          urls: "turn:"+ turnserver_ip + ":" + turnserver_port,
          credential: 'Tony020731',
          username: 'BlackTony'
      },
      {urls: 'stun:' + turnserver_ip + ":" + turnserver_port}
